---
title: The Foreign Earned Income Exclusion Explained: Tests, Limits, and What It Covers
description: A plain-language guide to the Foreign Earned Income Exclusion, the two qualifying tests, the 2025 limit, and what it does and does not cover, for Americans living in San Miguel de Allende.
parent: taxes-and-the-feie
source_chapters: [ch2.md, appendix-legal.md, ch16.md]
---

# The Foreign Earned Income Exclusion Explained: Tests, Limits, and What It Covers
...
| --- | --- |
| Wages and salary for work done abroad | Dividends and interest |
| Self-employment income for work done abroad | Capital gains |
| | Rental income |
...
The tax pillar covers how the FEIE fits alongside Mexican tax residency, the FBAR and FATCA filings you cannot skip, and the state-tax traps. Read [Taxes and the FEIE](../taxes-and-the-feie.md) next, and explore the full relocation guide and community for current figures and cross-border CPA referrals before you file.
