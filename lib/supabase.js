...
export function mapEvent(r) {
  return {
    ...
    recurDays: Array.isArray(r.recur_days) ? r.recur_days : [],
    recurNote: bi(r.recur_note || null, r.recur_note_es || r.recur_note || null),
    ...
    imgAttr: (Array.isArray(r.photo_attributions) && r.photo_attributions[0]) || "",
...
const LIST_META = {
  ...
  wellness: { es: "Bienestar y spas", en: "Wellness & spas", cat: "bienestar" },
  parks:    { es: "Parques y aire libre", en: "Parks & outdoors", cat: "tours" },
  culture:  { es: "Arte y cultura", en: "Arts & culture", cat: "cine" },
  shopping: { es: "Compras", en: "Shopping", cat: "mercados" },
};
const LIST_ORDER = ["rest", "bar", "wellness", "parks", "culture", "shopping"];
...
export function mapPlace(r) {
  return {
    ...
    whyLove: bi(r.why_love, r.why_love_es),         // editorial: why we love it
    whatToOrder: bi(r.what_to_order, r.what_to_order_es), // editorial: what to order
    bestTime: bi(r.best_time, r.best_time_es),      // editorial: best time to go
  };
}
