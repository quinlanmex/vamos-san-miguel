...
-- ========== 2) Cuisine facet + backfill ==========
-- Vamos San Miguel: add + backfill the cuisine facet on Local Picks.
-- Safe to run more than once. Matches rows by their Google Maps URL (source_ref).
...
update places set cuisine = '{cafe,breakfast}' where source_ref = 'https://www.google.com/maps/place/Art+Garden+Cafe/data=!4m2!3m1!1s0x842b51304c6774af:0x79153f81de9c2f4d';
update places set cuisine = '{dessert,bakery,cafe,breakfast}' where source_ref = 'https://www.google.com/maps/place/Bakery+Sucr%C3%A9,+SMA./data=!4m2!3m1!1s0x842b517f9b654abd:0x44b06f9836864de7';
update places set cuisine = '{mexican,cafe,breakfast}' where source_ref = 'https://www.google.com/maps/place/Caf%C3%A9+1910/data=!4m2!3m1!1s0x842b51b332774101:0x4d177224222f57ca';
update places set cuisine = '{cafe}' where source_ref = 'https://www.google.com/maps/place/Caf%C3%A9+Murmullo/data=!4m2!3m1!1s0x842b51a43eb4057f:0xf5da16f054687e96';
...
update places set cuisine = '{cafe}' where source_ref = 'https://www.google.com/maps/place/Divino+Cielo+Caf%C3%A9/data=!4m2!3m1!1s0x842b51a925c1b391:0x10a18688099555c8';
update places set cuisine = '{mexican}' where source_ref = 'https://www.google.com/maps/place/D%C3%B4ce+18+Concept+House/data=!4m2!3m1!1s0x842b51b9febb1f15:0x58c9a31bef506707';
update places set cuisine = '{cafe}' where source_ref = 'https://www.google.com/maps/place/El+Caf%C3%A9+Instituto+Allende+Casa+Museo/data=!4m2!3m1!1s0x842b51fca2b03c8f:0x9d76d16d48e3ee69';
update places set cuisine = '{italian}' where source_ref = 'https://www.google.com/maps/place/Fari+Trattoria/data=!4m2!3m1!1s0x842b5138a8c49afb:0x22a7d01dfb490f96';
update places set cuisine = '{italian}' where source_ref = 'https://www.google.com/maps/place/Firenze+Restaurant+-+San+Miguel+de+Allende/data=!4m2!3m1!1s0x842b51ba41cada87:0x4bdaaa3f90b2b6a9';
update places set cuisine = '{argentinian}' where source_ref = 'https://www.google.com/maps/place/Florios+San+Miguel/data=!4m2!3m1!1s0x842b511b34cc7e19:0x3157a9356fe0cb8d';
...
update places set cuisine = '{cafe}' where source_ref = 'https://www.google.com/maps/place/KAFFI/data=!4m2!3m1!1s0x842b51ad09750e47:0x3bd64872ec181741';
update places set cuisine = '{cafe}' where source_ref = 'https://www.google.com/maps/place/La+Cabra+Iluminada/data=!4m2!3m1!1s0x842b5123082609db:0x7fabb38637369ebb';
...
update places set cuisine = '{cafe}' where source_ref = 'https://www.google.com/maps/place/Mam%C3%A1+M%C3%ADa/data=!4m2!3m1!1s0x842b51b0b009254b:0x7f73204dcb2ba260';
update places set cuisine = '{cafe,breakfast}' where source_ref = 'https://www.google.com/maps/place/Mi+Bistro+300/data=!4m2!3m1!1s0x842b51b71e2e0b99:0x828c168e958dd6f9';
...
update places set cuisine = '{cafe,breakfast}' where source_ref = 'https://www.google.com/maps/place/Petit+Four/data=!4m2!3m1!1s0x842b51b7412b1dc7:0xf9c753590aa4d5b7';
...
update places set cuisine = '{cafe}' where source_ref = 'https://www.google.com/maps/place/Zibu+Allende/data=!4m2!3m1!1s0x842b517780690f77:0x986d088ad8081e73';
